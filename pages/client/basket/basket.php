...
<body>
					...
					<div class="create-order-content">
						...
						<div class="create-order-form">
							...
							<form method="POST" action="basket.php">
								<input type="text" value="<?=$city?>" name="city" placeholder="Город">
								<br><input type="text" value="<?=$street?>" name="street" placeholder="Улица">
								<br><input type="text" value="<?=$house?>" name="house" placeholder="Дом">
								<br><input type="number" value="<?=$flat?>" name="flat" placeholder="Этаж">
								<br><input type="number" value="<?=$apartament?>" name="apartament" placeholder="Квартира">
								<br><input type="text" value="<?=$intercom?>" name="intercom" placeholder="Домофон">
								<br><input type="text" value="<?=$index?>" name="index" placeholder="Индекс">
								<br><input type="radio" class="input-radio1" name="type_of_pay" value="Оплата онлайн"><label class="radio-text">Оплата онлайн</label>
								<input type="radio" checked class="input-radio2" name="type_of_pay" value="Оплата при получении"><label class="radio-text">Оплата при получении</label>
								<?php if($count == 0) : ?>
	...
	<script src="/saycheese/assets/scripts/ajax/edit-basket.js" defer></script>
