...
<head>
	...
	<link rel="stylesheet" href="/saycheese/assets/styles/client/catalog/catalog_item.css">
</head>
			...
			<div class="item_block">
				...
				<div class="item-media_block">
					...
					<div class="item-price-basket_block">
						...
						<div class="btn_item-basket">
							<a class="btn-link add_basket" id="<?=$selected_product['id']?>">
								<p class="btn-text">Добавить в коризну</p>
							</a>
						</div>
					</div>
				</div>
