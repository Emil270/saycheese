$(document).ready(function () {
	...
	if(window.location.hash.substr(1) == "TriggerAfterEditionProduct"){
	...
	// Отправка POST-запроса для редактирования выбранного товара //
		...
		$.ajax({
			...
			success: function (data) {
				if(data.status == "0"){
					...
					window.location.hash = "TriggerAfterEditionProduct";
